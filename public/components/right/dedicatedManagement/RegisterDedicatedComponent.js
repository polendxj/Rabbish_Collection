...
class CreateDedicatedFormComponent extends Component {
    ...
    render() {
        ...
        console.log(this.props.accessControlType)
        return (
            <form className="form-horizontal" action="#">
                <div className="row" style={{height: tableHeight + "px", overflowY: "scroll"}}>
                    <div className="col-md-8 col-md-offset-2">
                        ...
                        <div id="visitControlDIV" style={{display: 'none'}}>
                            <fieldset className="content-group">
                                ...
                                <div className="form-group" id="whitelistRadio">
                                    <label
                                ...
                                <div className="form-group" id="blacklistRadio" style={{display: 'none'}}>
                                    <label
                                        className="control-label col-lg-2">{Current_Lang.tableTitle.STBID}</label>
                                    <div className="col-lg-10">
                                        <input id="blacklistSTBID" type="text" className="form-control"
                            ...
                            <div className="text-right">
                                <button type="button" className="btn btn-primary"
                                        onClick={this.props._save.bind(this, this.props.accessControlType)}
