...
export default class RegisterCSEGroupComponent extends Component {
    ...
    _save() {
        ...
        sgids.substring(0, sgids.length - 2);
        if (!flag) {
            ...
            if (i != idx) {
                ...
                this.sgidRangeItems.push(
                    <tr key={'sgid' + count} className={'sgid' + count}>
                        ...
                        <td className="text-center">
                            <input placeholder={Current_Lang.tableTitle.SGIDRangeStart} min="0" className="form-control" name="number" value={start}/>
                        </td>
                        <td className="text-center">
                            <input placeholder={Current_Lang.tableTitle.SGIDRangeEnd} min="0" className="form-control" name="number" value={end}/>
                        </td>
                        <td className="text-center">
