...
export default class UnVerifiedStore extends Component {
    constructor(props) {
        super(props);
                    ...
                    tb.push(<tr key={key} style={{backgroundColor: key % 2 == 0 ? "#F8F8F8" : ""}}>
                        ...
                        <td className="text-center">
                            <div className="thumbnail" style={{margin: "0 auto", width: "35px", padding: 0, border: 0}}>
                                <div className="thumb">
                                    <img src={val.logo ? (hasHttp ? val.logo : imgBaseUrl + val.logo) : "../assets/images/no_photo.gif"} alt="" style={{height: "30px", width: "30px"}}/>
                                    <div className="caption-overflow" style={{width: "auto"}}>
                                        <span style={{top: 0, marginTop: 0}}>
                                            <a href={val.logo ? (hasHttp ? val.logo : imgBaseUrl + val.logo) : "../assets/images/no_photo.gif"} data-popup="lightbox"
