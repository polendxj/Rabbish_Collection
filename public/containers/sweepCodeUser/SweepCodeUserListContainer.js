...
export default class SweepCodeUserListContainer extends Component {
    constructor(props) {
        super(props);
        this.page=0;
        this.breadCrumbs = [
        ...
        this.operation = [
            {icon: "icon-add-to-list", text: Current_Lang.others.add, action: "/CustomerService/SweepCodeUserManage/Register"}
        ];
            ...
            <div>
                ...
                <div className="content" style={{marginTop: '20px'}}>
                    ...
                    <fieldset className="content-group">
                        ...
                        <SweepCodeUserListComponent data={this.dataList} fetching={false}
...
class SweepCodeUserListComponent extends Component{
    constructor(props) {
        super(props)
    }
...
export default connect(mapStateToProps)(SweepCodeUserListContainer)